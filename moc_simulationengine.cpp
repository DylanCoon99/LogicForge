...
#include <memory>
#include "src/model/simulationengine.h"
...
QT_MOC_LITERAL(1, 17, 18), // "simulationComplete"
QT_MOC_LITERAL(2, 36, 0), // ""
QT_MOC_LITERAL(3, 37, 19) // "oscillationDetected"

    },
    "SimulationEngine\0simulationComplete\0"
    "\0oscillationDetected"
};
...
void SimulationEngine::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->simulationComplete(); break;
        case 1: _t->oscillationDetected(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (SimulationEngine::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SimulationEngine::simulationComplete)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (SimulationEngine::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SimulationEngine::oscillationDetected)) {
                *result = 1;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject SimulationEngine::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_meta_stringdata_SimulationEngine.data,
    qt_meta_data_SimulationEngine,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
// SIGNAL 0
void SimulationEngine::simulationComplete()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void SimulationEngine::oscillationDetected()
{
